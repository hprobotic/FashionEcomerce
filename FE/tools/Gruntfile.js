module.exports = function(grunt) {
            ...
            dist: {
                files: [{
                    ...
                    src: [
                        ...
                        '.htaccess',
                        // 'img/{,*/}*.{jpg,jpeg,png,gif,webp,cur,mp4,webm}',
                        'img/**/*',
                        'css/fontface.css',
        ...
        browserSync: {
            dev: {
                bsFiles: {
                    ...
                    src : ['<%= devDir %>/**/*.html', '<%= devDir %>/template/**/*.html', '<%= devDir %>/js/**/*.js', '<%= devDir %>/**/*.css']
                },
                options: {
                    watchTask: true,
                    ports: {
            ...
            dist1: {
                ...
                options: {
                    replacements: [{
                        ...
                        pattern: /src=js\//g,
                        replacement: 'src=/wp-content/themes/etypes/www/js/'
                    }, {
                        pattern: /src=img\//g,
                        replacement: 'src=/wp-content/themes/etypes/www/img/'
                    }]
                }
            },
            dist2: {
                ...
                options: {
                    replacements: [{
                        ...
                        replacement: "<?php $parse_uri = explode( 'wp-content', $_SERVER['SCRIPT_FILENAME'] ); $parse_uri[0] = str_replace('index.php', '', $parse_uri[0]); require_once( $parse_uri[0] . '/wp-load.php' ); ?><!DOCTYPE html>"
                    }, {
                        pattern: '</head>',
                        replacement: [
                            '<script>',
                            'var templateUrl = "<?php echo get_bloginfo("template_url"); ?>/www";',
                            'var WPDomain = location.protocol+"//"+location.hostname+(location.port ? ":"+location.port: "");',
                            '</script>',
                            '</head>'
                        ].join('\n')
                    }, {
                        pattern: /href="css\//g,
                        replacement: 'href="<?php echo get_bloginfo("template_url"); ?>/www/css/'
                    }, {
                        pattern: /src="js\//g,
                        replacement: 'src="<?php echo get_bloginfo("template_url"); ?>/www/js/'
                    }, {
                        pattern: /href="img\//g,
                        replacement: 'href="<?php echo get_bloginfo("template_url"); ?>/www/img/'
                    }, {
                        pattern: /content="img\//g,
                        replacement: 'content="<?php echo get_bloginfo("template_url"); ?>/www/img/'
                    }, {
                        pattern: /src="img\//g,
                        replacement: 'src="<?php echo get_bloginfo("template_url"); ?>/www/img/'
                    }, {
                        pattern: /url\(img\//g,
                        replacement: 'url(<?php echo get_bloginfo("template_url"); ?>/www/img/'
                    }]
                }
            },
            dist3: {
                ...
                options: {
                    replacements: [{
                        pattern: /img\/samples/g,
                        replacement: '/wp-content/themes/etypes/www/img/samples'
                    }, {
                        pattern: /video\/samples/g,
                        replacement: '/wp-content/themes/etypes/www/video/samples'
                    }]
                }
            }
        }
    ...
    grunt.registerTask('build', [
        ...
        'usemin',
        'copy:dist2',
        'string-replace:dist2',
        'string-replace:dist3'
    ]);
